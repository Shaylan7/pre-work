...
function exercise4(varA, varB) {
  ...
  // --------------------------------------------
  if (varA == varB) {
    answer4 = "var A and varB are equal";
  } else answer4 = "varA and varB differ"; 
  // --------------------------------------------
  // And above here
  // --------------------------------------------
  return answer4;
...
function exercise9(item) {
  ...
  } else answer9 = ("Please send a number, that was a " + typeof(item)+ ".")
  // check what number 
  // assign string to answer 9 
  // --------------------------------------------
  // And above here
  // --------------------------------------------
  return answer9;
